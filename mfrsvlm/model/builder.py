...
from mfrsvlm.model import VHMLlamaForCausalLM


def _is_mfrsvlm_model(model_name: str) -> bool:
    model_name = model_name.lower()
    return any(tag in model_name for tag in ("mfrsvlm", "mf-rsvlm", "vhm"))


def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    kwargs = {"device_map": device_map}
    is_mfrsvlm = _is_mfrsvlm_model(model_name)
    ...
    if is_mfrsvlm:
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            print('Loading MF-RSVLM from base model...')
            ...
            print('Loading additional MF-RSVLM weights...')
